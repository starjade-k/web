 ...
 <div class="page-title">
   ...
   <form method="post" action="BoardServlet">
   	<input type="hidden" name="command" value="add_plan">
   	   	<input type="hidden" name="planYN" value="Y">
          ...
          <div class="row g-3">
			...
			<div class="col-sm-4">
              ...
              <!-- 교수 로그인 받은후 수정필요 -->
              <input type="text" class="form-control" id='professorName' name="professorName" required readonly value="${name.professorName }"> 
            ...
            <div class="col-sm-12">
             ...
             <input type="text" class="form-control" id='week1' name="week1" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">2주차</label>
             <input type="text" class="form-control" id='week2' name="week2" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">3주차</label>
             <input type="text" class="form-control" id='week3' name="week3" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">4주차</label>
             <input type="text" class="form-control" id='week4' name="week4" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">5주차</label>
             <input type="text" class="form-control" id='week5' name="week5" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">6주차</label>
             <input type="text" class="form-control" id='week6' name="week6" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">7주차</label>
             <input type="text" class="form-control" id='week7' name="week7" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">8주차</label>
             <input type="text" class="form-control" id='week8' name="week8" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">9주차</label>
             <input type="text" class="form-control" id='week9' name="week9" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">10주차</label>
             <input type="text" class="form-control" id='week10' name="week10" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">11주차</label>
             <input type="text" class="form-control" id='week11' name="week11" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">12주차</label>
             <input type="text" class="form-control" id='week12' name="week12" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">13주차</label>
             <input type="text" class="form-control" id='week13' name="week13" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">14주차</label>
             <input type="text" class="form-control" id='week14' name="week14" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">15주차</label>
             <input type="text" class="form-control" id='week15' name="week15" required> 
              <span id="message"></span>
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">16주차</label>
             <input type="text" class="form-control" id='week16' name="week16" required> 
              <span id="message"></span>
            </div>
