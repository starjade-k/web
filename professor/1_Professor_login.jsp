...
<div class="whole-form">
    ...
    <hr class = "login-hr">
        ...
        <input type="hidden" name="command" value="loginProfessor">
            <div class="input-container">
                <label for="username" class = "label-flex">아이디</label>
                <input type="text" id="professorNum" name="professorNum" placeholder="아이디를 입력해 주세요." onfocus="this.placeholder = ''" onblur="this.placeholder = '아이디를 입력해 주세요.'">
            </div>
            <div class="input-container">
            ...
            <div class="radio">
				...
				<input type="radio" name="loginCheck" value="professor" checked="checked"  onclick = "location.href='1_Professor_login.jsp'">교수
